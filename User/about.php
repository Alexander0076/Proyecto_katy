        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              ...
              <h3 style="color: #aba9a9;">Nuestro objetivo es crear una mejor experiencia cliente en los lugares que este desee visitar y darle una aplicación de confianza donde puedan opinar de forma libre sobre el sabor, limpieza, atención y precios sin importar sean negativos o positivos.</h3>
